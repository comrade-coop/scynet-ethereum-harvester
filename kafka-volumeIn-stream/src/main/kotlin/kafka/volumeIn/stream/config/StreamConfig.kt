    ...
    companion object {
        fun getStreamProperties(): Properties {
            return Properties().apply {
                ...
                setProperty(StreamsConfig.APPLICATION_ID_CONFIG, "volumeIn")
        ...
        fun getAddressBalanceStoreSupplier(): StoreBuilder<KeyValueStore<String, String>> {
            return Stores.keyValueStoreBuilder(
                    Stores.persistentKeyValueStore("AddressVolumeIn"),
                    Serdes.String(),
                    Serdes.String()
            )
        }
        ...
        fun getBlockAddressBalanceStoreSupplier(): StoreBuilder<KeyValueStore<Int, AddressFeature.AddressFeatureMap>> {
            return Stores.keyValueStoreBuilder(
                    Stores.persistentKeyValueStore("BlockNumberAddressVolumeIn"),
                    Serdes.Integer(),
